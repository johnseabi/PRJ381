...
{
   public class iOSTutorClass
    {
        private string fullNames;
        private string module;
        private string campus;
        private string contactNumber;
        private string communicationMode; //e.g Watsapp, phone call or email
        ...
        public iOSTutorClass(string fullNames, string module, string campus
